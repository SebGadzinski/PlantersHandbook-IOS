...
///SeasonsPickerViewModalView.swift - View for SeasonsPickerViewModalViewController
class SeasonsPickerViewModalView: GeneralView {
    
    internal let titleLabel = SUI.label(title: "Seasons", fontSize: FontSize.largeTitle)
    ...
    internal let checkBoxLabel = SUI.label(title: "Change All Graphs", fontSize: FontSize.medium)
